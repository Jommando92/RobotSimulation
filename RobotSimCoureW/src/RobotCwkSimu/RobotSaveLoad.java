package RobotCwkSimu;
	...
	//    import javax.swing.filechooser.FileNameExtensionFilter;
		...
		public class RobotSaveLoad {
			 ...
			 */
			public RobotSaveLoad(String ftypeD, String fExtension) {
			...
			public static void main(String[] args) {
				...
				RobotSaveLoad tf = new RobotSaveLoad("Text files", "txt");		// create object looking for *.txt Text files
